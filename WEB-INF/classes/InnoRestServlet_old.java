 ...
 */
	...
	ctx = this.getServletContext();
        ...
        try {
            ...
            log.fine("InnoRestServlet xmlUrl: "+xmlUrl);
            String xmlIn = null;
            ...
            try {
                ...
                log.severe("InnoRestServlet  processRequest threw exception while trying to get metadata using xmlUrl "+xmlUrl+e);
                return;
            }
            ...
            if (xslParm == null || xslParm.equals("")) {
                ...
                if (((!inSS)) && (!inLeg)) {
                    out.println("Unsupported xsl parm supplied to InnoRestServlet "+xslParm);
                    return;
                }
            }
            String htmlOut = "";
    ...
    /**
     * If the xslParm is "metadata_to_html_full", check to see if the xml is actually data-gov, and if so
     * return that ss, otherwise return "metadata_to_html_full"
     */
    ...
    public static String[] getUrlContents(String urlStr, HttpServletRequest request, String contentType) throws Exception {
        ...
        try {
            ...
            log.finest("getContentType: "+contentType);
            is = u.openStream();
