  ...
  try {
    ...
    switch (format) {
      case html: {
          ...
          printHtml(msgBroker, writer, record, styleUrl,contextPath);
        }
        break;
      case htmlfragment: {
          SearchResultRecord record = dao.getMetadataAsSearchResultRecord(id);
...
private void printHtml(MessageBroker msgBroker, 
                       ...
                       String [] styleUrl,
                       String contextPath) throws SearchException {
  ...
  writer.println("<head>");
   writer.println("<script>var contextPath = '"+contextPath+ "';</script>");
  writer.println("<script type='text/javascript' src='"+contextPath+"/catalog/js/jquery-ui/js/jquery.js'></script>");
  writer.println("<script type='text/javascript' src='"+contextPath+"/catalog/js/jquery-ui/js/jquery-ui.js'></script>");
  writer.println("<script type='text/javascript' src='"+contextPath+"/catalog/collection/js/manageBody.js'></script>");
...
private void printKml(MessageBroker msgBroker, PrintWriter writer, final SearchResultRecord record) {
  ...
  //Modified  by Baohong
  SearchResultRecordsAdapter searchResultRecordsAdapter = new SearchResultRecordsAdapter(records);
  kmlWriter.write(searchResultRecordsAdapter);
...
private void printPjson(MessageBroker msgBroker, PrintWriter writer, final SearchResultRecord record, Format format) {
  ...
  //Modified  by Baohong
  SearchResultRecordsAdapter searchResultRecordsAdapter = new SearchResultRecordsAdapter(records);
  jsonWriter.write(searchResultRecordsAdapter);
