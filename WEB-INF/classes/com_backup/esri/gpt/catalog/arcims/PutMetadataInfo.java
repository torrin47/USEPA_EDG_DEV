...
private String   _xml = "";
private String   _schemaKey = "";  // JSS - from schema def file
...
/**
 * Gets the schema key - JSS 20110325 - from schema def file
 * @return the schemaKey string
 */
public String getSchemaKey() {
  return _schemaKey;
}
/**
 * Sets the schemaKey string for the document.  - JSS 20110325 - from schema def file
 * @param schemaKey the schemaKey string
 */
