...
// properties ==================================================================
    ...
    public boolean isPolicyUnrestricted() {
        if (getCriteria().getActionCriteria().getMetadataAccessPolicyType() != null) {
            return getCriteria().getActionCriteria().getMetadataAccessPolicyType().equalsIgnoreCase(MetadataAccessPolicy.TYPE_UNRESTRICTED);
        }
        return false;
    }
...
// methods =====================================================================
    ...
    protected void processSubAction(ActionEvent event, RequestContext context)
        ...
        this.session.setAttribute("mmdUuids", this.getActionCriteria().getSelectedRecordIds());
            
        if (sCommand.equals("")) {
            session.setAttribute("mmdUuids", null);
            // set the sort option
