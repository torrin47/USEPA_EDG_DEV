...
import com.innovateteam.gpt.innoHelperFunctions;
  ...
  protected void execute(HttpServletRequest request,
    ...
    try {		
      ...
      if (key.length() > 0) {
        ...
        innoHelperFunctions obj = new innoHelperFunctions();
        sResponse = obj.addCollectionDataToTocTreeResponse(tree.generateResponse(tocContext),request);
