...
<f:subview id="svSecondaryNavigation">
    ...
    <h:form id="frmSecondaryNavigationForCollection" 
            rendered="#{(PageContext.tabStyleMap['catalog.collection.home']!='' or PageContext.tabStyleMap['catalog.collection.manage']!='' or PageContext.tabStyleMap['catalog.collection.virtualResource']!='')}">

        <h:commandLink
            id="collectionList" 
            action="catalog.collection.home"
            value="#{gptMsg['catalog.collection.collection.List']}"
            styleClass="#{PageContext.tabStyleMap['catalog.collection.home']}"
            title="List"/>
        
         <h:commandLink
            id="collectionManage" 
            action="catalog.collection.manage"
            value="#{gptMsg['catalog.collection.collection.Manage']}"
            styleClass="#{PageContext.tabStyleMap['catalog.collection.manage']}"
            title="Manage"/>
         
         <h:commandLink
            id="collectionVirtualResource" 
            action="catalog.collection.virtualResource"
            value="#{gptMsg['catalog.collection.collection.VirtualResource']}"
            styleClass="#{PageContext.tabStyleMap['catalog.collection.virtualResource']}"
            title="PlaceholderRecord"/>
    </h:form>
</f:subview>
